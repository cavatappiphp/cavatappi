...
/**
 * A general-purpose base for Value objects that includes several interfaces and traits and is declared `readonly`.
 */
abstract readonly class DefaultReadOnlyValueBase implements Value, Clonable, Reflectable, Validated {
	use EqualityKit;
	use CloneKit;
	use ValidatedKit;
	use ReflectableKit;
