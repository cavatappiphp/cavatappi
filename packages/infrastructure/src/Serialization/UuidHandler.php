 ...
 */
class UuidHandler implements Exporter, Importer {
	/**
	...
	public function canImport(Field $field, string $format): bool {
		return is_a($field->phpType, UuidInterface::class, allow_string: true);
	}
	 ...
	 * @return UuidInterface Deserialization result
	 */
	public function importValue(Deserializer $deserializer, Field $field, mixed $source): mixed {
		...
		return UuidFactory::fromString($string);
	}
}
